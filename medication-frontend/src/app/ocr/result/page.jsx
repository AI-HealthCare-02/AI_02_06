...
export default function OcrResultPage() {
  ...
  useEffect(() => {
    // 1. donghoon의 리다이렉트 로직: 저장된 데이터가 없으면 뒤로 보냄
  ...
  return (
    <main className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="bg-white border-b border-gray-200 px-10 py-4 flex items-center gap-4">
        ...
        <div>
          <h1 className="font-bold text-gray-900">처방전 인식 결과</h1>
      ...
      <div className="max-w-3xl mx-auto px-10 py-8 space-y-4">
        ...
        <div className="flex gap-3 pb-10">
          ...
          <button
            ...
            className="flex-1 bg-blue-500 text-white py-4 rounded-xl font-semibold cursor-pointer hover:bg-blue-600 transition-all active:scale-[0.98]">
            확인
          </button>
        </div>
      </div>
