      ...
      <div className="max-w-5xl mx-auto px-10 py-10 flex gap-10">
        <div className="w-64 shrink-0">
          ...
          <div className="space-y-4 text-sm text-gray-400">
            <div className="flex gap-3"><span className="text-blue-500 font-bold">1</span><p>처방전 사진을 업로드하세요</p></div>
            <div className="flex gap-3"><span className="text-blue-500 font-bold">2</span><p>AI가 약품 정보를 자동으로 인식해요</p></div>
            <div className="flex gap-3"><span className="text-blue-500 font-bold">3</span><p>인식된 정보를 확인하고 저장하세요</p></div>
          </div>
        ...
        <div className="flex-1">
          ...
          <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 flex gap-3 px-10 py-4">
            ...
            <button
              ...
              disabled={!file}
              className="flex-1 bg-blue-500 text-white py-4 rounded-xl font-semibold cursor-pointer hover:bg-blue-600 disabled:opacity-50">
              분석하기
            </button>
          </div>
        </div>
